module.exports = {
    ...
    async execute(client, message , args) {
     ...
     if(!args[0]) return message.sent("Lütfen kayıt edilecek kişiyi belirtiniz.")
     let kişi = message.mentions.members.first() || message.guild.members.cache.get(args[0])   
     if(!kişi) return message.sent("Lütfen kayıt edilecek kişiyi belirtiniz.")
     ...
     mention.woman(mention.isTagges() ? bot.config.tagınız : bot.config.tagsız ,  args[1] , args[2] , message)
